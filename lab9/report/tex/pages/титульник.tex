...
\begin{center}
    ...
    \large <<Объектно-ориентированное программирование>>\\[10pt] 
    \large Курсовая работа <<Телефонный справочник>>\\[5pt] 
\end{center}

\vspace{90 pt}

\begin{tabular*}{460pt}{@{\extracolsep{\fill}} l r l}
    Выполнил студент\tabularnewline группы 5130201/40002 & \hspace{35pt} \line(1,0){100} \hspace{-52pt} & Семенов И. А.\\
     & \\
     Проверил \tabularnewline преподователь & \hspace{35pt} \line(1,0){100} \hspace{-52pt} & Кирпиченко С. Р. \\
     & \\
     & \\
     & \\
